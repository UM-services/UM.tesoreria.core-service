 ...
 * 
 */
package um.tesoreria.core.hexagonal.asiento.application.service;
...
import um.tesoreria.core.hexagonal.asiento.infrastructure.persistence.repository.JpaAsientoRepository;
