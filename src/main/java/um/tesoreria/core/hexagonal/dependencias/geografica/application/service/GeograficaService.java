 ...
 * 
 */
package um.tesoreria.core.hexagonal.dependencias.geografica.application.service;
...
import um.tesoreria.core.hexagonal.dependencias.geografica.domain.ports.in.GetGeograficasBySedeUseCase;
