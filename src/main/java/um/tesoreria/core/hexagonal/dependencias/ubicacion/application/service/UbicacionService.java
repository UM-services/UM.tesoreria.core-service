package um.tesoreria.core.hexagonal.dependencias.ubicacion.application.service;
...
import um.tesoreria.core.hexagonal.dependencias.ubicacion.domain.ports.in.GetUbicacionesBySedeUseCase;
