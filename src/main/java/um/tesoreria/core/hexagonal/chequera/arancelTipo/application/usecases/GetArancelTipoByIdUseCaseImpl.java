...
import um.tesoreria.core.hexagonal.chequera.arancelTipo.domain.ports.in.GetArancelTipoByIdUseCase;
import um.tesoreria.core.hexagonal.chequera.arancelTipo.domain.ports.out.ArancelTipoRepository;
import java.util.Optional;

@Component
@RequiredArgsConstructor
public class GetArancelTipoByIdUseCaseImpl implements GetArancelTipoByIdUseCase {
    private final ArancelTipoRepository repository;
    @Override
    public Optional<ArancelTipo> getArancelTipoById(Integer id) {
        return repository.findByArancelTipoId(id);
    }
}
