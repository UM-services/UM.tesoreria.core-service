...
import um.tesoreria.core.hexagonal.chequera.chequeraCuota.domain.ports.in.FindAllDebidasUseCase;
...
public class FindAllDebidasUseCaseImpl implements FindAllDebidasUseCase {
    ...
    public List<ChequeraCuota> findAllDebidas(Integer facultadId, Integer tipoChequeraId, Long chequeraSerieId, Integer alternativaId) {
        ...
        return repository.findAllDebidas(facultadId, tipoChequeraId, chequeraSerieId, alternativaId, OffsetDateTime.now());
    }
}
