...
import um.tesoreria.core.hexagonal.chequera.chequeraCuota.domain.ports.in.CalculateTotalCuotasActivasUseCase;
...
public class CalculateTotalCuotasActivasUseCaseImpl implements CalculateTotalCuotasActivasUseCase {
    ...
    public BigDecimal calculateTotalCuotasActivas(Integer facultadId, Integer tipoChequeraId, Long chequeraSerieId, Integer productoId, Integer alternativaId) {
        return repository.findAllByCuotasActivas(facultadId, tipoChequeraId, chequeraSerieId, productoId, alternativaId, (byte) 0)
                .stream()
