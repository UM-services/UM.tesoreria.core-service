package um.tesoreria.core.hexagonal.personas.documento.infrastructure.persistence.adapter;
...
import um.tesoreria.core.hexagonal.personas.documento.infrastructure.persistence.mapper.DocumentoMapper;
import um.tesoreria.core.hexagonal.personas.documento.infrastructure.persistence.repository.JpaDocumentoRepository;
...
public class JpaDocumentoRepositoryAdapter implements DocumentoRepository {
    ...
    @Override
    public Optional<Documento> findFirstByGuaraniTipoDocumento(Integer guaraniTipoDocumento) {
        return jpaDocumentoRepository.findFirstByGuaraniTipoDocumento(guaraniTipoDocumento)
                .map(documentoMapper::toDomainModel);
    }
