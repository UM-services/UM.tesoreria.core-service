 ...
 * 
 */
package um.tesoreria.core.hexagonal.arancelTipo.application.service;
...
import um.tesoreria.core.hexagonal.arancelTipo.infrastructure.persistence.repository.JpaArancelTipoRepository;
