...
@Data
@Entity
@Table(name = "vw_chequera_cuota_deuda", uniqueConstraints = { @UniqueConstraint(columnNames = { "chc_fac_id",
		"chc_tch_id", "chc_chs_id", "chc_pro_id", "chc_alt_id", "chc_cuo_id" }) })
@Immutable
@EqualsAndHashCode(callSuper = false)
@NoArgsConstructor
@AllArgsConstructor
public class ChequeraCuotaDeuda extends Auditable implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 7226436297860442622L;
